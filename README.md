...
CS senior at Santa Clara University (graduating June 2026), focused on building backend and systems software with Python, FastAPI, PostgreSQL, and Linux.

## Skills and Stack

- Languages: Python, SQL, Bash
- Backend: FastAPI, REST APIs
- Data and Storage: PostgreSQL
- Systems: Linux, containerized workflows, monitoring tooling
- Interests: Open source infrastructure and systems
...
- Applied AI Intern, NeoHiveMind Solutions
- Software Engineering Intern, Mindstix Software Labs
